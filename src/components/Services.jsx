    ...
    <Section id="how-to-use">
      <div className="container">
        <Heading
          ...
          text="Brainwave unlocks the potentional 0f AI-powered applications"
        />
          ...
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <p className="body-2 mb-[3rem] text-n-3">
                Brainwave unlocks the potentional for AI-powered application
              </p>
            ...
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15">
                <div className="flex items-center gap-3">
                  ...
                  <Tagline className="mb-1"> Beta</Tagline>
                </div>
                <p className="body-2 mb-[3rem] text-n-3">
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                <div className="flex items-center justify-end gap-3">
                  ...
                  <Tagline className="-mb-10 mr-20 lg:mb-1">Beta</Tagline>
                </div>
                <p className="body-2 mb-[2rem] text-n-3 flex">
                ...
                <ul className="flex items-center justify-between">
                  {brainwaveServicesIcons.map((icon, index) => (
                    <li
                      className={`flex items-center justify-center rounded-2xl hover:scale-125 transition-all duration-700 ${
                        index === 2
